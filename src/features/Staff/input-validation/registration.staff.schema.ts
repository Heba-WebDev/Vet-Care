...
const staffRegistrationValidation = async (req: Request, res: Response, next: NextFunction) => {

  try {
    await staffRegistrationSchema.validateAsync(req.body);
    next();
  } catch (error ) {
...
export { staffRegistrationValidation };
