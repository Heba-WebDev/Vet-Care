...
export class StaffMapper {
  static staffEntityFromObject(staffEntity: StaffEntity) {
    const { id, name, job_title, permission_type, email, phone_number, verified } = staffEntity;
    ...
    return new StaffEntity(id, name, job_title, permission_type, email, phone_number, verified);
  }
}
